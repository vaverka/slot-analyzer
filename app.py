# ==============================================================================
#  app.py - УНИВЕРСАЛЬНЫЙ АНАЛИЗАТОР СЛОТОВ V7.8 (фикс шага ставки и округления)
# ==============================================================================
...
class SlotProbabilityCalculator:
    def __init__(self, config):
        ...
        # реальный шаг ставки из JSON (поддержка вариантов ключа)
        self.bet_step = float(
            gc.get('bet_step') or
    ...
    def generate_bankroll_strategy(self, personal_bankroll, risk_level='medium'):
        ...
        # используем реальный шаг ставки из JSON

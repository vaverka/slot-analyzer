# ==============================================================================
#  app.py - УНИВЕРСАЛЬНЫЙ АНАЛИЗАТОР СЛОТОВ V6.1 (финальная, полная версия)
# ==============================================================================
import json
import math
import pandas as pd
    ...
    if analyze_button and uploaded_file:
        try:
            ...
            with st.expander("Как понимать эти цифры и почему мы считаем спины 'до разорения'? 🤔"):
                ...
                Поэтому "количество спинов до разорения" (или "игровое время") — это единственная величина, которую можно рассчитать как математическое ожидание. **Это ваш "запас прочности" против преимущества казино.**
                ...
                **"Запас прочности"** — это расчетное время, которое вы можете продержаться на воде, прежде чем течение вас унесет (**разорение**). Чем дольше вы держитесь, тем выше шанс, что за это время рядом с вами появится спасательный круг.
                """)
